...
from deep_blue_genome.core.database import entities
...
class Job(object):
    ...
    Concurrently using the same job in multiple DBG contexts using the same
    ...
    name : str
        ...
        other projects using the same DBG database.
...
def pipeline_cli(Context, create_jobs):
    ...
    Context 
        ...
        deep_blue_genome.core.cli.AlgorithmMixin or a subclass thereof.
