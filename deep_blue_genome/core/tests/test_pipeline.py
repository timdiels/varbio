...
'''
Test deep_blue_genome.core.pipeline
'''

from deep_blue_genome.core.pipeline import LocalJobServer, DRMAAJobServer, pipeline_cli, JobFailedError, Job
...
def assert_execution_order(caplog, events):
    ...
    with caplog.atLevel(logging.INFO, logger='deep_blue_genome.core.pipeline'):
        yield
