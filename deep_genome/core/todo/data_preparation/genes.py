...
from deep_genome.core.reader.ncbi import read_gene_info_file_chunked
...
from deep_genome.core.database.gene import Gene, GeneName
...
def load_gene_info(database):
    ...
    '''
    Load gene info data from NCBI into DG database
